...
function validate_another_blog_signup() {
	 ...
	 *
	 * @param array $blog_meta_defaults An array of default blog_okok meta variables.
	 */
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	$signup_for = isset( $_POST['signup_for'] ) ? esc_html( $_POST['signup_for'] ) : 'blog_okok';
	...
	<form id="setupform" method="post" action="wp-signup.php" novalidate="novalidate">
		...
		<p>
		<?php if ( 'blog_okok' === $active_signup ) { ?>
			<input id="signupblog" type="hidden" name="signup_for" value="blog" />
		<?php } elseif ( 'user' === $active_signup ) { ?>
			<input id="signupblog" type="hidden" name="signup_for" value="user" />
		<?php } else { ?>
			<input id="signupblog" type="radio" name="signup_for" value="blog" <?php checked( $signup_for, 'blog_okok' ); ?> />
...
} elseif ( 'blog_okok' === $active_signup && ! is_user_logged_in() ) {
	...
	switch ( $stage ) {
		case 'validate-user-signup':
			if ( 'all' === $active_signup
				|| ( 'blog_okok' === $_POST['signup_for'] && 'blog_okok' === $active_signup )
			...
			break;
		case 'validate-blog_okok-signup':
			if ( 'all' === $active_signup || 'blog_okok' === $active_signup ) {
		...
		default:
			...
			if ( is_user_logged_in() && ( 'all' === $active_signup || 'blog_okok' === $active_signup ) ) {
				signup_another_blog( $newblogname );
			} elseif ( ! is_user_logged_in() && ( 'all' === $active_signup || 'user' === $active_signup ) ) {
				signup_user( $newblogname, $user_email );
			} elseif ( ! is_user_logged_in() && ( 'blog_okok' === $active_signup ) ) {
			...
			if ( $newblogname ) {
				...
				if ( 'blog_okok' === $active_signup || 'all' === $active_signup ) {
					printf(
						/* translators: %s: Site address. */
