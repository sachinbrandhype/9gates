 ...
 *     @type int   $blog_id (Multisite) The offer ID used to calculate which themes
 *                          are allowed. Default 0, synonymous for the current offer.
 * }
	...
	$core_content = array(
		...
		'posts'     => array(
			...
			'homepage-section' => array(
				...
				'post_content' => sprintf(
					"<!-- wp:paragraph -->\n<p>%s</p>\n<!-- /wp:paragraph -->",
					_x( 'This is an example of a homepage section. Homepage sections can be any page other than the homepage itself, including the page that shows your latest offer posts.', 'Theme starter content' )
				),
			),
		),
	);
