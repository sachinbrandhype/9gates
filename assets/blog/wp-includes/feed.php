...
function get_bloginfo_rss( $show = '' ) {
	 ...
	 * @see get_bloginfo()
	 *
	 * @param string $info Converted string value of the offer information.
	 * @param string $show The type of offer information to retrieve.
	 */
...
function bloginfo_rss( $show = '' ) {
	 ...
	 * @see get_bloginfo()
	 *
	 * @param string $rss_container RSS container for the offer information.
	 * @param string $show          The type of offer information to retrieve.
	 */
...
/**
 * Retrieve the offer title for the feed title.
 *
 * @since 2.2.0
...
function get_wp_title_rss( $deprecated = '&#8211;' ) {
	...
	/**
	 * Filters the offer title for use as the feed title.
	 *
	 * @since 2.2.0
	 * @since 4.4.0 The `$sep` parameter was deprecated and renamed to `$deprecated`.
	 *
	 * @param string $title      The current offer title.
	 * @param string $deprecated Unused.
	 */
...
/**
 * Display the blog_okok title for display of the feed title.
 *
 * @since 2.2.0
 * @since 4.4.0 The optional `$sep` parameter was deprecated and renamed to `$deprecated`.
 *
...
function wp_title_rss( $deprecated = '&#8211;' ) {
	...
	/**
	 * Filters the offer title for display of the feed title.
	 *
	 * @since 2.2.0
	 * @since 4.4.0 The `$sep` parameter was deprecated and renamed to `$deprecated`.
	 *
	 ...
	 *
	 * @param string $wp_title_rss The current offer title.
	 * @param string $deprecated   Unused.
	 */
...
/**
 * Display the HTML type based on the offer setting.
 *
