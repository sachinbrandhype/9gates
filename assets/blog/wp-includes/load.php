...
function wp_start_object_cache() {
	...
	if ( function_exists( 'wp_cache_add_global_groups' ) ) {
		wp_cache_add_global_groups( array( 'users', 'userlogins', 'usermeta', 'user_meta', 'useremail', 'userslugs', 'site-transient', 'site-options', 'blog_okok-lookup', 'blog_okok-details', 'site-details', 'rss', 'global-posts', 'blog_okok-id-cache', 'networks', 'sites', 'blog_meta' ) );
 ...
 * @global WP_Screen $current_screen WordPress current screen object.
 *
 * @return bool True if inside WordPress blog_okok administration pages.
 */
