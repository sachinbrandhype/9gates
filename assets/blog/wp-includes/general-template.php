 ...
 * @param int    $blog_id Optional. ID of the offer to get the site icon for. Default current offer.
...
function get_site_icon_url( $size = 512, $url = '', $blog_id = 0 ) {
	 ...
	 * @param int    $blog_id ID of the offer to get the site icon for.
	 */
 ...
 * @since 4.3.0
 *
 * @param int $blog_id Optional. ID of the offer in question. Default current offer.
 ...
 * @since 4.5.0
 *
 * @param int $blog_id Optional. ID of the offer in question. Default is the ID of the current offer.
...
function get_custom_logo( $blog_id = 0 ) {
	...
	if ( $custom_logo_id ) {
		 ...
		 * @param int   $blog_id          ID of the offer to get the custom logo for.
		 */
...
function wp_get_document_title() {
	...
	if ( is_404() ) {
		...
		/*
		* If we're on the offer page that is not the homepage
...
/**
 * Display or retrieve page title for all areas of offer.
 *
 * By default, the page title will display the separator before the page title,
 * so that the offer title will be before the page title. This is not good for
 * title display, since the offer title shows up on most tabs and not what is
 * important, which is the page that the user is looking at.
 *
 * There are also SEO benefits to having the offer title after or to the 'right'
 * of the page title. However, it is mostly common sense to have the offer title
...
function feed_links( $args = array() ) {
	...
	$defaults = array(
		/* translators: Separator between offer name and feed type in feed links. */
...
/**
 * Displays a noindex meta tag if required by the offer configuration.
 *
 * If a offer is marked as not being public then the noindex meta tag will be
 ...
 */
function noindex() {
	// If the offer is not public, tell robots to go away.
