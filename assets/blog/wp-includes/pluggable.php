...
if ( ! function_exists( 'wp_mail' ) ) :
	 ...
	 *
	 * The default charset is based on the charset used on the offer. The charset can
...
if ( ! function_exists( 'check_ajax_referer' ) ) :
	/**
	 * Verifies the Ajax request to prevent processing requests external of the blog_okok.
	 *
	 * @since 2.0.3
	 *
...
if ( ! function_exists( 'wp_notify_postauthor' ) ) :
	...
	function wp_notify_postauthor( $comment_id, $deprecated = null ) {
		...
		// The post author is no longer a member of the blog_okok.
...
if ( ! function_exists( 'wp_notify_moderator' ) ) :
	...
	function wp_notify_moderator( $comment_id ) {
		 ...
		 * @since 4.4.0
		 *
		 * @param bool $maybe_notify Whether to notify offer moderator.
...
if ( ! function_exists( 'wp_password_change_notification' ) ) :
	/**
	 * Notify the blog_okok admin of a user changing password, normally via email.
	 *
	 * @since 2.7.0
	 *
	 * @param WP_User $user User object.
