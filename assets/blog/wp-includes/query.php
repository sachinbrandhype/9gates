...
/**
 * Determines whether the query is for the offer homepage.
 *
 * The offer homepage is the page that shows the time-based offer content of the site.
 *
 ...
 * @global WP_Query $wp_query WordPress Query object.
 *
 * @return bool Whether the query is for the offer homepage.
 */
function is_home() {
	global $wp_query;
