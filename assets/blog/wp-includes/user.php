 ...
 * spammer, or if the user's primary offer has been marked as spam.
 *
 * @since 3.7.0
 *
 * @param WP_User|WP_Error|null $user WP_User or WP_Error object from a previous callback. Default null.
...
function get_user_option( $option, $user = 0, $deprecated = '' ) {
	...
	} elseif ( $user->has_prop( $option ) ) { // User-specific and cross-offer.
...
/**
 * Update user option with global offer capability.
 *
 * User options are just like user metadata except that they have support for
 * global offer options. If the 'global' parameter is false, which it is by default
 ...
 * @param bool   $global      Optional. Whether option name is global or offer specific.
 *                            Default false (offer specific).
...
/**
 * Delete user option with global offer capability.
 *
 * User options are just like user metadata except that they have support for
 * global offer options. If the 'global' parameter is false, which it is by default
 * it will prepend the WordPress table prefix to the option name.
...
/**
 * Find out whether a user is a member of a given offer.
 *
 * @since MU (3.0.0)
 *
 * @global wpdb $wpdb WordPress database abstraction object.
 ...
 * @param int $blog_id Optional. ID of the offer to check. Defaults to the current site.
 * @return bool
 */
 ...
 *     @type int          $blog_id                 ID of offer (Multisite only). Default is ID of the current offer.
