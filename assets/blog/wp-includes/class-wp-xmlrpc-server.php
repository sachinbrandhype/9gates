...
class wp_xmlrpc_server extends IXR_Server {
	...
	public function initialise_blog_option_info() {
		...
		/**
		 * Filters the XML-RPC offer options property.
		 *
		 * @since 2.6.0
		 *
		 * @param array $blog_options An array of XML-RPC offer options.
		 */
	 ...
	 *  - 'isAdmin'
	 *  - 'isPrimary' - whether the offer is the user's primary offer
	 *  - 'url'
	 *  - 'blogid'
	 *  - 'blogName'
	...
	/**
	 * Retrieve offer options value from list.
	 *
	 * @since 2.6.0
	 *
	...
	/**
	 * Retrieve the list of categories on a given offer.
	 *
	 * @since 1.5.0
	 *
	 * @param array $args {
	...
	/**
	 * Retrieve list of all categories on offer.
	 *
	 * @since 1.5.0
	 *
	 * @param array $args {
