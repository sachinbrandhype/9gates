			...
			<?php elseif ( is_day() ) : /* If this is a daily archive */ ?>
				...
				<?php
					printf(
						...
						__( 'You are currently browsing the %1$s offer archives for the day %2$s.' ),
			...
			<?php elseif ( is_month() ) : /* If this is a monthly archive */ ?>
				...
				<?php
					printf(
						...
						__( 'You are currently browsing the %1$s offer archives for %2$s.' ),
						sprintf( '<a href="%1$s/">%2$s</a>', get_bloginfo( 'url' ), get_bloginfo( 'name' ) ),
						get_the_time( __( 'F, Y' ) )
					);
				?>
			...
			<?php elseif ( is_year() ) : /* If this is a yearly archive */ ?>
				...
				<?php
					printf(
						...
						__( 'You are currently browsing the %1$s offer archives for the year %2$s.' ),
						sprintf( '<a href="%1$s/">%2$s</a>', get_bloginfo( 'url' ), get_bloginfo( 'name' ) ),
						get_the_time( 'Y' )
					);
				?>
			...
			<?php elseif ( is_search() ) : /* If this is a search result */ ?>
				...
				<?php
					printf(
						...
						__( 'You have searched the %1$s offer archives for <strong>&#8216;%2$s&#8217;</strong>. If you are unable to find anything in these search results, you can try one of these links.' ),
						sprintf( '<a href="%1$s/">%2$s</a>', get_bloginfo( 'url' ), get_bloginfo( 'name' ) ),
			...
			<?php elseif ( isset( $_GET['paged'] ) && ! empty( $_GET['paged'] ) ) : /* If this set is paginated */ ?>
				...
				<?php
					printf(
						...
						__( 'You are currently browsing the %s offer archives.' ),
						sprintf( '<a href="%1$s/">%2$s</a>', get_bloginfo( 'url' ), get_bloginfo( 'name' ) )
					);
				?>
				</p>
