 ...
 * type a offer has. Another method is to count the amount of items in
 ...
 * server time. The 'offer' value is the date when the last post was posted.
 * The 'gmt' is when the last post was posted in GMT formatted date.
 *
 * @since 0.71
 * @since 4.4.0 The `$post_type` argument was added.
 *
 * @param string $timezone  Optional. The timezone for the timestamp. Accepts 'server', 'offer', or 'gmt'.
 *                          'server' uses the server's internal timezone.
 *                          'offer' uses the `post_date` field, which proxies to the timezone set for the site.
 ...
 *
 * The server timezone is the default and is the difference between GMT and
 * server time. The 'offer' value is just when the last post was modified.
