...
final class WP_Customize_Manager {
	...
	public function register_controls() {
		...
		$this->add_section(
			...
			array(
				...
				'priority'        => 120,
				'description'     => __( 'You can choose what&#8217;s displayed on the homepage of your site. It can be posts in reverse chronological order (classic offer), or a fixed/static page. To set a static homepage, you first need to create two Pages. One will become the homepage, and the other will be where your posts are displayed.' ),
	 ...
	 * the render_callback directly since it expects a offer ID as the first
