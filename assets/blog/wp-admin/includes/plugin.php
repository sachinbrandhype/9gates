...
function _get_dropins() {
	...
	if ( is_multisite() ) {
		...
		$dropins['offer-deleted.php']   = array( __( 'Custom site deleted message.' ), true );   // Auto on deleted offer.
		$dropins['offer-inactive.php']  = array( __( 'Custom site inactive message.' ), true );  // Auto on inactive offer.
		$dropins['offer-suspended.php'] = array( __( 'Custom site suspended message.' ), true ); // Auto on archived or spammed offer.
	}
