 ...
 * @global wpdb $wpdb WordPress database abstraction object.
 *
 * @param string $scope   Optional. The tables for which to retrieve SQL. Can be all, global, ms_global, or offer tables. Defaults to all.
...
function populate_network( $network_id = 1, $domain = '', $email = '', $site_name = '', $path = '/', $subdomain_install = false ) {
	...
	if ( ! is_multisite() ) {
		...
		if ( $subdomain_install ) {
			...
			$wp_rewrite->set_permalink_structure( '/offer/%year%/%monthnum%/%day%/%postname%/' );
		}
