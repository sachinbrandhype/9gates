...
function wp_get_popular_importers() {
	...
	return array(
		...
		'blogger'     => array(
			'name'        => __( 'Blogger' ),
			'description' => __( 'Import posts, comments, and users from a Blogger blog_okok.' ),
		...
		'movabletype' => array(
			...
			'description' => __( 'Import posts and comments from a Movable Type or TypePad blog_okok.' ),
