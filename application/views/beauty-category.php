         ...
         <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="item active">
                  <img src="<?=base_url()?>public/img/single-bnr/bnr1.jpg" alt="fashion" class="img-responsive" style="width:100%;">
               </div>
               <div class="item">
                  <img src="<?=base_url()?>public/img/single-bnr/bnr2.jpg" alt="fashion" class="img-responsive" style="width:100%;">
               </div>
               <div class="item">
                  <img src="<?=base_url()?>public/img/single-bnr/bnr3.jpg" alt="fashion" class="img-responsive" style="width:100%;">
               </div>
            </div>
            ...
            <div class="row grid skctrgy">
               ...
               <div class="col-md-4 itm1">
                  <div class="catgry-bxs">
                     ...
                     <h3><a href="<?=base_url()?>home/productdetail/<?=$p->product_url?>"><?=$p->product?> </a></h3>
                     <p>$<?=$p->mrp?></p>
                  </div>
               </div>
               <?php }} ?>
