      ...
      <div class="container-fluid navbar-me">
         ...
         <div class="row skmn2">
                  ...
                  <div class="container-fluid">
                     ...
                     <div id="navbar2 navbar-primary-collapse" class="navbar-collapse collapse sk2-nv">
                        <ul class="nav navbar-nav navbar-center sk-nv3">
                            <?php 
                            $url = 'beauty-gate';
                            $m = $this->homemodel->getMenuId($url);
                            $cat = $this->homemodel->getCategoryDataById($m->id);
                            if(!empty($cat)){
                              $count=1;
                              foreach($cat as $bc){
            ...
            <div class="col-md-1">
               <div class="myact">
                  <ul class="ab-actwi">
                     <li><a href="<?=base_url()?>cart" id="OpenFormokokok"><i id="cart" class="fa fa-shopping-bag crt-ic" aria-hidden="true" ><?php echo count($this->cart->contents()); ?></i> </a></li>
