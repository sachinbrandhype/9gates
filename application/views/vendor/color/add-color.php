                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/color/saveColor" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="color_code" required="">
                                            <div class="valid-feedback">Color!</div>
                                        </div>
