                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/brand/update/<?= $brand->has_very?>" method="post" enctype="multipart/form-data">

                                    <div class="row g-3">

                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Brand Name</label>
                                            <input class="form-control" type="text" name="brand"  value="<?=$brand->name?>">
                                            <div class="valid-feedback">Brand Name!</div>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom02">Url</label>
                                            <input class="form-control" type="text" name="url" id="url" value="<?= $brand->url?>">
                                            <div class="valid-feedback">Url!</div>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Brand Description</label>
                                            <textarea class="form-control" type="text" name="description" required=""><?=$brand->description?></textarea>
                                            <div class="valid-feedback">Brand Description!</div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <img src="<?=site_url()?>uploads/<?= $brand->image ?>" style="height: 57px;width: 57px">
