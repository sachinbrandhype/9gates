                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/country/updateCity/<?= $city->has_very?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                            ...
                                            <select class="form-control" name="country" id="country" required="">
                                                ...
                                                <?php if(!empty($country)){
                                                    foreach($country as $c){?>
                                                        <option value="<?=$c->id?>"<?php if($c->id == $city->country){?><?php echo "selected";}?>><?=$c->country?></option>
                                                    <?php }} ?>
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="state" id="state" required="">
                                                ...
                                                <?php if(!empty($state)){
                                                    foreach($state as $c){?>
                                                        <option value="<?=$c->id?>"<?php if($c->id == $city->state){?><?php echo "selected";}?>><?=$c->state?></option>
                                                    <?php }} ?>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="city" value="<?=$city->city?>">
