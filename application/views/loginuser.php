					...
					<div class="lgn-bbdy ottps">
						...
						<?php //echo $this->session->userdata('id')?>
							<div class="form-group">
								<input type="text" name="phone" class="form-control ssgn-s3" placeholder="7982127409">
								<span class="message" id="msgphone"></span>
							</div>
							<div class="otps-lble">
								<p>Welcome back Nykaa user, Please enter your password to continue</p>
							</div>
							<div class="input-group form-group">
					          <input type="password" class="form-control pwd sks-pwd" name ="pass">
					          <span class="input-group-btn">
					            <button class="btn sk-pwd-shw reveal" type="button">show</button>
					          </span> 
					          <span class="message" id="msgpass"></span>
					        </div>
							<div class="form-group">
								<input type="button" class="but-lgn-sbs" id="isValidateLogin" value="Login">
							</div>
							<p>Login via OTP</p>
						</form>
					</div>
...
$('#emaillogin').show();*/
    ...
    $(document).on('click','#isValidateLogin', function() {
	if (isValidateLogin()) {
...
function isValidateLogin() {
	...
	if (phone.length == 0 ) {
		valid = false;
		$("#msgphone").html("Enter valid details");
		$("#msgphone").show();
	}
	
	if (pass.length == 0 ) {
		valid = false;
		$("#msgpass").html("Enter valid details");
		$("#msgpass").show();
	}
