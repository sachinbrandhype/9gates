                            ...
                            <div class="card-body">
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <tr>
                                            <th>S.No</th>
                                            <th>Weight From(in gm)</th>
                                            <th>Weight To(in gm)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=site_url('admin/shipping/edit/').$s->has_very?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                             <a href="<?=site_url('admin/shipping/delete/'.$s->has_very)?>" class="btn btn-warning">Delete</a> </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
                                        <tfoot>
