                                ...
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$c->heading?></td>
                                            <td><?=$c->content?></td>
                                            <td><img src="<?=base_url()?>uploads/<?=$c->image?>" style="width:57px;height:57px"></td>
                                            <td><a href="<?=site_url('admin/gift/edit/').$c->id?>" class="btn btn-primary">Edit</a>
                                             <a href="<?=site_url('admin/gift/delete/'.$c->id)?>" class="btn btn-warning">Delete</a> </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
                                        <tfoot>
