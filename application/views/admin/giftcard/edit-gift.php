                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/gift/update/<?= $gif->id?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" id="validationCustomUsername" type="text" name="heading" id="heading" aria-describedby="inputGroupPrepend" value="<?=$gif->heading?>">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" id="validationCustomUsername" type="text" name="url" id="url" aria-describedby="inputGroupPrepend" value="<?=$gif->url?>">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <textarea class="form-control" id="validationCustomUsername" name="content" aria-describedby="inputGroupPrepend"><?=$gif->content?></textarea>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <img src="<?=site_url()?>uploads/<?= $gif->image ?>" style="height: 57px;width: 57px">
