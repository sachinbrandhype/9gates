                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/wallet/saveDebit" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <input class="form-control" type="hidden" name="type" value="Direct">
                                        <input class="form-control" type="hidden" name="data_type" value="debit">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" type="text" name="username" required="">
                                                ...
                                                <?php if(!empty($user)){
                                                    foreach($user as $u){?>
                                                        <option value="<?=$u->fname.'__'.$u->id?>"><?=$u->fname?></option>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="debit_balance" required="">
