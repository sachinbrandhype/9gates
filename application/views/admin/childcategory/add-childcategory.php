                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/childcategory/saveChildCategory" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="childcategory" id="childcategory" required="">
                                            <div class="valid-feedback">Child Category!</div>
                                        </div>

                                        <!--<div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Child Category Description</label>
                                            <textarea class="form-control" type="text" name="description" required=""></textarea>
                                            <div class="valid-feedback">Child Category Description!</div>
                                        </div>-->
...
<script>
    ...
    $(document).ready(function(){
        $('#menu').change(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo site_url('admin/childcategory/menuBycategory'); ?>",
                    method:"POST",
                    data:{menu:menu},
