                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/offer/save" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea class="form-control" type="text" name="shourt_content" id="shourt_content" required=""></textarea>
                                            <div class="valid-feedback">Shourt Content!</div>
                                        </div>

                                        <div class="col-md-12">
                                            <label class="form-label" for="validationCustom01">Content</label>
                                            <textarea class="form-control" type="text" name="content" id="id_cazary_full" style="height:200px;width:100%;" required=""></textarea>
...
<script>
    $("#school_name").bind("keyup", changed).bind("change", changed);
    function changed() {
