                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/product/save" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="number" name="hsnno">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea class="form-control" type="text" name="short_description" ></textarea>
...
<script>
    ...
    $(document).ready(function(){
        $('#subcategory').change(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo site_url('admin/product/subcategoryBycolor'); ?>",
                    method:"POST",
                    data:{subcategory:subcategory},
                    success:function(data)
                    {
    ...
    $(document).ready(function(){
        $('#subcategory').change(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo site_url('admin/product/subcategoryBysize'); ?>",
                    method:"POST",
                    data:{subcategory:subcategory},
                    success:function(data)
                    {
    ...
    $(document).ready(function(){
        $('#subcategory').change(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo site_url('admin/product/subcategoryByattributegroup'); ?>",
                    method:"POST",
                    data:{subcategory:subcategory},
                    success:function(data)
                    {
