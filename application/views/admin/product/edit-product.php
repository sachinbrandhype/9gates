                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/product/update/<?= $pro->has_very?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="id_cazary_full" style="height:200px;width:100%;" type="text" name="image_descripton"><?=$pro->description?></textarea>
