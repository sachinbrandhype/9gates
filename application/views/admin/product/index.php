                                ...
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=site_url('admin/product/edit/').$s->has_very?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                             <a href="<?=site_url('admin/product/delete/'.$s->has_very)?>" class="btn btn-warning">Delete</a>
                                             <a href="<?=site_url('admin/order/invoice/'.$s->id)?>" class="btn btn-warning">Invoice</a>
                                             </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
