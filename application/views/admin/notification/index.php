                            ...
                            <div class="card-body">
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        <thead>
                                        <tr>
                                            <th><input type="checkbox" name="mycheck[]"></th>
                                            <th>App Id</th>
                                            <th>&nbsp;</th>
                                        </tr>
                                        </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo substr($n->appid,0,50)?></td>
                                            <td><a href="<?=site_url('admin/notification/send/').$n->appid?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Send Notification</a>
                                              </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
