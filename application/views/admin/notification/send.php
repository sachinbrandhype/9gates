                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="http://bumaco.herokuapp.com/sendNotification" method="get" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="token" value="<?= $noti->appid?>">
