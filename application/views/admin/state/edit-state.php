                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/country/updateState/<?= $state->has_very?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <select class="form-control" name="country" required="">
                                                ...
                                                <?php if(!empty($country)){
                                                    foreach($country as $c){?>
                                                        <option value="<?=$c->id?>"<?php if($c->id == $state->country){?><?php echo "selected";}?>><?=$c->country?></option>
                                                    <?php }} ?>
                                            </select>
