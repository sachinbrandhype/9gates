                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/color/update/<?= $color->has_very?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="category" id="category">
                                                ...
                                                <?php if(!empty($cat)){
                                                    foreach($cat as $c){?>
                                                        <option value="<?=$c->id?>"<?php if($c->id==$color->category){?><?php echo "selected";} ?>><?=$c->category?></option>
                                                    <?php }} ?>
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="subcategory">
                                                ...
                                                <?php if(!empty($sub)){
                                                    foreach($sub as $s){
                                                ?>
                                                <option value="<?=$s->id?>" <?php if($s->id == $color->subcategory){?><?php echo "selected";}?>><?=$s->subcategory?></option>
                                                <?php }} ?>
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="color" value="<?=$color->color?>">
                                            <div class="valid-feedback">Color!</div>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Color Code</label>
                                            <input class="form-control" type="text" name="color_code" value="<?=$color->color_code?>">
                                            <div class="valid-feedback">Color Code!</div>
                                        </div>
