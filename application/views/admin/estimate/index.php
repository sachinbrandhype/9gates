...
<head>
    ...
    <title>All Estimate Delivery</title>
    <!-- Google font-->
                                ...
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <?php if(!empty($estimate)){
                                            $count=1;
                                            foreach($estimate as $s){?>
                                        <tr>
                                            <td><?=$count?></td>
                                            <td><?=$s->delv_day?></td>
                                            <td><?= htmlentities($s->createdate)?></td>
                                            <td><a href="<?=site_url('admin/estimate/edit/').$s->has_very?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                             <a href="<?=site_url('admin/estimate/delete/'.$s->has_very)?>" class="btn btn-warning">Delete</a> </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
                                        <tfoot>
