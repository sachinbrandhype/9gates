                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/country/update/<?= $size->has_very?>" method="post" enctype="multipart/form-data">

                                    <div class="row g-3">

                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Country</label>
                                            <input class="form-control" type="text" name="country" required="" value="<?=$country->country?>">
