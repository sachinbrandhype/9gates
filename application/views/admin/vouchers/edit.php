                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/promotion/update/<?= $size->id?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                         ...
                                         <div class="col-md-4">
                                            ...
                                            <div class="valid-feedback">Type!</div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="valid-feedback">Link!</div>
                                        </div>
