                                ...
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$s->discount?></td>
                                            <td><?=$s->link?></td>
                                            <td><img src ="<?=base_url().'uploads/'.$s->image?>" style="width:57px;height:57px"></td>
                                            <td><?= htmlentities($s->date)?></td>
                                            <!--<td><a href="<?=site_url('admin/country/edit/').$s->has_very?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                             <a href="<?=site_url('admin/country/delete/'.$s->has_very)?>" class="btn btn-warning">Delete</a> </td>-->
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
                                        <tfoot>
