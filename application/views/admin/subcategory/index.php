                                ...
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <?php if(!empty($sub)){
                                            $count=1;
                                            foreach($sub as $s){
                                                //$menu = $this->submodel->getMenuById($s->menu);
                                                ?>
                                        <tr>
                                            <td><?=$count?></td>
                                            <td><?=$s->menu?></td>
                                            ...
                                            <td><a href="<?=site_url('admin/subcategory/edit/').$s->has_very?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                             <a href="<?=site_url('admin/subcategory/delete/'.$s->has_very)?>" class="btn btn-warning">Delete</a> </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
                                        <tfoot>
