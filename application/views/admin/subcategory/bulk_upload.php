...
<div class="card">
    ...
    <div class="card-body">
        <form class="needs-validation" action="<?=site_url()?>admin/subcategory/saveImport" method="post" enctype="multipart/form-data">
            <div class="row g-3">

                <div class="col-md-4">
                    <label class="form-label" for="validationCustom01">Bulk Upload Subcategory</label>
                    <input class="form-control" type="file" name="csv" required="">
                    <div class="valid-feedback">Bulk Upload Subcategory!</div>
                </div>
            ...
            <button class="btn btn-primary" name="import" type="submit">Submit</button>
        </form>
    </div>
</div>
