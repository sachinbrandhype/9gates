                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/subcategory/saveSubCategory" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="subcategory" id="subcategory" required="">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" id="validationCustomUsername" type="file" multiple name="bannerimage[]" aria-describedby="inputGroupPrepend">
