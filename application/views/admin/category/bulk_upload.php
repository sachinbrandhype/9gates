...
<div class="card">
    ...
    <div class="card-body">
        <form class="needs-validation" action="<?=site_url()?>admin/category/saveImport" method="post" enctype="multipart/form-data">
            <div class="row g-3">

                <div class="col-md-4">
                    <label class="form-label" for="validationCustom01">Bulk Upload Product</label>
                    <input class="form-control" type="file" name="csv" required="">

                    <div class="valid-feedback">Bulk Upload Product!</div>
                </div>
