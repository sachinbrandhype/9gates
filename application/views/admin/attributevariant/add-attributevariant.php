...
<head>
    ...
    <title>Add Attribute Variant</title>
    <!-- Google font-->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/attributevariant/saveAttributevariant" method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Attribute Group</label>
                                            <select class="form-control" name="attributegroup" id="attributegroup" required="">
                                            <option>Select Attribute Group</option>
                                                <?php if(!empty($attrgroup)){
                                                    foreach($attrgroup as $attr){?>
                                               <option value="<?=$attr->id?>"><?=$attr->attributegroup?></option>
                                            <?php }} ?>
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" name="attributevariant" id="attributevariant" required="">
                                            <div class="valid-feedback">Attribute Group!</div>
                                        </div>
