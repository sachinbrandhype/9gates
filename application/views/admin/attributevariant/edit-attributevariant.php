...
<head>
    ...
    <title>Edit Attribute Variant</title>
    <!-- Google font-->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" action="<?=site_url()?>admin/attributevariant/update/<?= $attrvariant->has_very?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="attributegroup" id="attributegroup">
                                                ...
                                                <?php if(!empty($attrgroup)){
                                                    foreach($attrgroup as $c){?>
                                                        <option value="<?=$c->id?>"<?php if($c->id == $attrvariant->attributegroup){?><?php echo "selected";} ?>><?=$c->attributegroup?></option>
                                                    <?php }} ?>
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label" for="validationCustom01">Attribute Variant</label>
                                            <input class="form-control" type="text" name="attributevariant" value="<?=$attrvariant->attributevariant?>">
                                            <div class="valid-feedback">Attribute Variant!</div>
                                        </div>
