                                ...
                                <div class="dt-ext table-responsive">
                                    <table class="display" id="focus-cell">
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$s->coupon_code?></td>
                                            <td><?=$s->coupon_type?></td>
                                            <td><?=$s->coupon_value?></td>
                                            <td><?=$s->amount?></td>
                                            <td><?= htmlentities($s->start_date)?></td>
                                            <td><?= htmlentities($s->end_date)?></td>
                                            <td><a href="<?=site_url('admin/coupon/edit/').$s->has_very?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                             <a href="<?=site_url('admin/coupon/delete/'.$s->has_very)?>" class="btn btn-warning">Delete</a> </td>
                                        </tr>
                                        <?php $count++;}}?>
                                        </tbody>
                                        <tfoot>
