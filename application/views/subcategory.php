                     ...
                     <ul>
                        <li class="sub sbp9">
                           ...
                           $category = explode('-scat.html',$url);
                            $catid = $this->homemodel->getSubCategoryIdByUrlDataListByFilter($category[0]);?>
                           ...
                           <ul>
                              ...
                              <li><a href="javascript:void(0)" class="filter" id="high" dataid= "<?php if(!empty($catid->id)){?><?php echo $catid->id?><?php } ?>">Price: High</a></li>
                              <li><a href="javascript:void(0)" class="filter" id="low" dataid= "<?php if(!empty($catid->id)){?><?php echo $catid->id?><?php } ?>">Price: Low</a></li>
         ...
         <div class="col-sm-9">
            <div class="row grid skctrgy">
               ...
               <?php /*$url = $this->uri->segment(4);
                  $catid = $this->homemodel->getSubCategoryIdByUrlDataList($url);
                  
                  $product =$this->homemodel->getProductBySubcategoryurl($catid->id);*/
