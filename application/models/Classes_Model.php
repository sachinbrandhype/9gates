...
class Classes_Model extends CI_Model
{
    ...
    function getAllData()
    {
        $this->db->select('school.school_name,classes.class_name,classes.id');
        $this->db->from('classes');
        $this->db->join('school', 'classes.school_name =school.id ', 'inner');
        $query = $this->db->get();
        return $query->result();
    }
