...
class Product extends CI_Controller
{
     ...
     function return($offset=0)
    {
        ...
        $this->pagination->initialize($config);
        $data['cl'] = $this->product_model->getAll($config['per_page'],$offset);
        $data['all'] =$this->product_model->getAllReturn();
        $this->load->view('admin/product/return',$data);
    }
    
     function cancel($offset=0)
    {
        $this->load->library('pagination');
        $config['base_url'] = site_url('admin/product/order');
        $config['total_rows'] = $this->product_model->countAll();
        ...
        $this->pagination->initialize($config);
        $data['cl'] = $this->product_model->getAll($config['per_page'],$offset);
        $data['all'] =$this->product_model->getAllCancel();
        $this->load->view('admin/product/cancel',$data);
    }
    ...
    function add()
    {
        ...
        $data['menu'] =$this->product_model->getAllMenu();
    ...
    function edit($id)
    {
        ...
        $data['replace'] =$this->product_model->getAllReplacement();
        $data['estimate'] =$this->product_model->getAllEstimate();
        $data['pro'] = $this->product_model->getProductById($id);
        echo $prid = $data['pro']->id;
